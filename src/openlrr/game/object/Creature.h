...
void _Creature_RemoveNulls(CreatureModel* creature);
...
Gods98::Container* __cdecl Creature_GetActivityContainer(CreatureModel* creature);

// Merged function: Object_FindNull
// <LegoRR.exe @00406e80>
//#define Creature_FindNull ((Gods98::Container* (__cdecl* )(CreatureModel* creature, const char* name, uint32 frameNo))0x00406e80)
Gods98::Container* __cdecl Creature_FindNull(CreatureModel* creature, const char* name, uint32 frameNo);
...
// <LegoRR.exe @00406c60>
//#define Creature_MoveAnimation ((real32 (__cdecl* )(CreatureModel* creature, real32 elapsed, uint32 repeatCount))0x00406c60)
...
// <missing>
Gods98::Container* __cdecl Creature_GetFootStepNull(CreatureModel* creature);
...
// <inlined>
Gods98::Container* __cdecl Creature_GetThrowNull(CreatureModel* creature);
...
// <LegoRR.exe @00406f70>
//#define Creature_CheckThrowNull ((bool32 (__cdecl* )(CreatureModel* creature))0x00406f70)
