...
enum StatsFlags1 : uint32 // [LegoRR/Stats.c|flags:0x4|type:uint]
{
	...
	STATS1_PROCESSANY            = (STATS1_PROCESSORE|STATS1_PROCESSCRYSTAL),

	STATS1_ANYTELEPORTER         = (STATS1_SMALLTELEPORTER|STATS1_BIGTELEPORTER|STATS1_WATERTELEPORTER|STATS1_MANTELEPORTER),
};
