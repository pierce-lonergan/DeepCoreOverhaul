...
//Map3D* __cdecl Map3D_Create(Gods98::Container* root, const char* filename, real32 blockSize, real32 roughLevel);
...
//bool32 __cdecl Map3D_CheckBuildingTolerance(Map3D* map, const Point2I* shapePoints, uint32 shapeCount, real32 buildTolerance, real32 buildMaxVariation);
...
//void __cdecl Map3D_FlattenShapeVertices(Map3D* map, const Point2I* shapePoints, uint32 shapeCount, real32 mult_4_0);
...
//bool32 __cdecl Map3D_BlockToWorldPos(Map3D* map, uint32 bx, uint32 by, OUT real32* xPos, OUT real32* yPos);

// <LegoRR.exe @0044f990>
#define Map3D_WorldToBlockPos_NoZ ((bool32 (__cdecl* )(Map3D* map, real32 xPos, real32 yPos, OUT sint32* bx, OUT sint32* by))0x0044f990)
//bool32 __cdecl Map3D_WorldToBlockPos_NoZ(Map3D* map, real32 xPos, real32 yPos, OUT sint32* bx, OUT sint32* by);
...
//bool32 __cdecl Map3D_WorldToBlockPos(Map3D* map, real32 xPos, real32 yPos, OUT sint32* bx, OUT sint32* by, OUT real32* unk_zPos);

// <LegoRR.exe @0044fad0>
#define Map3D_FUN_0044fad0 ((void (__cdecl* )(Map3D* map, real32 xPos, real32 yPos, OUT sint32* bx, OUT sint32* by))0x0044fad0)
//void __cdecl Map3D_FUN_0044fad0(Map3D* map, real32 xPos, real32 yPos, OUT sint32* bx, OUT sint32* by);
...
//bool32 __cdecl Map3D_FUN_0044fb30(Map3D* map, const Point2F* wPos2D, OPTIONAL OUT Point2F* blockPosf, OPTIONAL OUT Point2F* centerDir);

// <LegoRR.exe @0044fc00>
#define Map3D_GetWorldZ ((real32 (__cdecl* )(LegoRR::Map3D* map, real32 xPos, real32 yPos))0x0044fc00)
//real32 __cdecl Map3D_GetWorldZ(LegoRR::Map3D* map, real32 xPos, real32 yPos);

// <LegoRR.exe @0044fd70>
#define Map3D_FUN_0044fd70 ((void (__cdecl* )(Map3D* map, real32 xPos, real32 yPos, OUT Vector3F* vector))0x0044fd70)
//void __cdecl Map3D_FUN_0044fd70(Map3D* map, real32 xPos, real32 yPos, OUT Vector3F* vector);
...
//bool32 __cdecl Map3D_FUN_0044fe50(Map3D* map, real32 xPos, real32 yPos, bool32 diagonal, real32 unkMultiplier, OUT real32* xOut, OUT real32* yOut);
...
//void __cdecl Map3D_GetBlockFirstVertexPosition(Map3D* map, sint32 vx, sint32 vy, OUT Vector3F* vector);
...
//void __cdecl Map3D_GetBlockVertexPositions_NoRot(Map3D* map, uint32 bx, uint32 by, OUT Vector3F* vertPoses);
...
//bool32 __cdecl Map3D_GetIntersections(Map3D* map, Gods98::Viewport* view, uint32 mouseX, uint32 mouseY, OUT uint32* bx, OUT uint32* by, OUT Vector3F* vector);
...
//bool32 __cdecl Map3D_Intersections_Sub1_FUN_00450820(Map3D* map, const Vector3F* rayOrigin, const Vector3F* ray, OUT Vector3F* endPoint, OUT Point2I* blockPos, sint32 unkCount);
...
//void __cdecl Map3D_AddVisibleBlocksInRadius_AndDoCallbacks(Map3D* map, sint32 bx, sint32 by, sint32 radius, OPTIONAL XYCallback callback);
...
//void __cdecl Map3D_BlockVertexToWorldPos(Map3D* map, uint32 bx, uint32 by, OUT real32* xPos, OUT real32* yPos, OUT real32* zPos);
...
//void __cdecl Map3D_SetBlockUVWobbles(LegoRR::Map3D* map, uint32 bx, uint32 by, bool32 on);
...
//void __cdecl Map3D_SetBlockDirectionNormal(Map3D* map, uint32 bx, uint32 by, Direction direction, const Vector3F* normal);
...
//bool32 __cdecl Map3D_GetBlockDirectionNormal(Map3D* map, uint32 bx, uint32 by, Direction direction, OUT Vector3F* normal);
...
//void __cdecl Map3D_MoveBlockDirectionVertex(Map3D* map, uint32 bx, uint32 by, Direction direction, const Vector3F* vertDist);
...
//void __cdecl Map3D_MapFileGetSpecs(const MapFileInfo* mapFileInfo, OUT uint32* width, OUT uint32* height);

// <LegoRR.exe @00451880>
#define Map3D_MapFileBlockValue ((uint16 (__cdecl* )(const MapFileInfo* mapFile, uint32 bx, uint32 by, uint32 gridWidth))0x00451880)
//uint16 __cdecl Map3D_MapFileBlockValue(const MapFileInfo* mapFile, uint32 bx, uint32 by, uint32 gridWidth);
...
//bool32 __cdecl Map3D_Intersections_Sub2_FUN_004518a0(Map3D* map, uint32 bx, uint32 by, const Vector3F* rayOrigin, const Vector3F* ray, OUT Vector3F* vector);
