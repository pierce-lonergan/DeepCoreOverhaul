...
//void __cdecl ScrollInfo_Initialise(const char* filename, bool32 index, uint32 unkFlags, sint32 param_4, sint32 param_5);
...
//void __cdecl ScrollInfo_AddStruct1C(bool32 index, bool32 use50InsteadOf4c, const Area2F* rect, OPTIONAL const char* filename1, OPTIONAL const char* filename2);
...
//void __cdecl ScrollInfo_AddCreateStruct28(bool32 index, Area2F* area, sint32 number, sint32 param_4, const char* filename);
...
//bool32 __cdecl ScrollInfo_Mouse_FUN_00463b60(OUT sint32* out_param_1, uint32 mouseX, uint32 mouseY, bool32 param_4, bool32 param_5);
...
//void __cdecl ScrollInfo_GetSubStruct28_Fields1C_20(bool32 index, OUT sint32* field1c, OUT sint32* field20);
